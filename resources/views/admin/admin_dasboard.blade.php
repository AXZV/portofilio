...
<script src="{{ asset('js/jquery-3.2.1.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('dist/jquery.vmap.js') }}"></script>
    <script type="text/javascript" src="{{ asset('dist/maps/jquery.vmap.indonesia.js') }}" charset="utf-8"></script>
    <script>
            (function($) {

...
function(t) {
    ...
    var e = function(t) {
        function e(e, o) {
            var n = e.prop("id");
            this.$left = e, this.$right = t(t(o.right).length ? o.right : "#" + n + "_to1"), this.actions = {
                $leftAll: t(t(o.leftAll).length ? o.leftAll : "#" + n + "_leftAll1"),
                $rightAll: t(t(o.rightAll).length ? o.rightAll : "#" + n + "_rightAll1"),
                $leftSelected: t(t(o.leftSelected).length ? o.leftSelected : "#" + n + "_leftSelected1"),
                $rightSelected: t(t(o.rightSelected).length ? o.rightSelected : "#" + n + "_rightSelected1"),
                $undo: t(t(o.undo).length ? o.undo : "#" + n + "_undo1"),
                $redo: t(t(o.redo).length ? o.redo : "#" + n + "_redo1"),
                $moveUp: t(t(o.moveUp).length ? o.moveUp : "#" + n + "_move_up1"),
                $moveDown: t(t(o.moveDown).length ? o.moveDown : "#" + n + "_move_down1")

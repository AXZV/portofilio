...
<!-- /////////////////////////////// Toast CTRL /////////////////////////////// -->
    ...
    @if (session()->has('successupdatecaption'))
    <?php  echo 
            "<script> 
        ...
        <!-- Card Wider -->
            <div class="card card-cascade wider">
                <div class="view view-cascade overlay">
                    <img  class="card-img-top imgcard" src="/assets/slider_img/{{$s->img}}" alt="Card image cap">
                    <a href="">
                ...
                <div class="card-body card-body-cascade text-center">
                    ...
                    <p class="card-text">{{$s -> caption}}</p>
                    <a href="javascript:;" data-toggle="modal" onclick="editimgslider( '{{$s -> id}}')" data-target="#modaleditimg" class="btn btn-info btn-sm"><i class="far fa-image"></i> Edit Image</a>
                    <a href="javascript:;" data-toggle="modal" onclick="editcaption( '{{$s -> id}}', '{{$s -> caption}}')" data-target="#modaleditcaption" class="btn btn-info btn-sm"><i class="far fa-comment-alt"></i> Edit Caption</a>
                </div>
            </div>
        <!-- Card Wider -->
    </div>

    ...
    <nav id="js-primary-nav" class="primary-nav" role="navigation">
        <ul id="js-nav-menu" class="nav-menu">
            ...
            <li class="<?php echo e($active == 'peminjamanAdd' ? 'active' : ''); ?>">
                <a href="<?php echo e(url('admin/instansi')); ?>" title="Application Intel" data-filter-tags="application intel">
            ...
            <li class="<?php echo e($active == 'peminjaman' ? 'active' : ''); ?>">
                <a href="<?php echo e(url('admin/guru')); ?>" title="Application Intel" data-filter-tags="application intel">
                    <i class="fal fa-credit-card-front"></i>

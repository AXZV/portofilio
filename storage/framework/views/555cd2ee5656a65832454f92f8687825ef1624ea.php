                                ...
                                <tbody>
                                    ...
                                    <tr style="width:1px; white-space:nowrap;">
                                        ...
                                        <td style="text-align:center">
                                            ...
                                            <?php elseif($i->role == 'Siswa'): ?>
                                                <span class="badge badge-warning">Siswa</span>
                                            <?php endif; ?>
                                        </td>
                                        <td style="text-align:center">
                                            <?php if($i->deleted_at === NULL): ?>  
                                                <a href="#" data-toggle="modal" onclick="deleteData(<?php echo e($i->id); ?>)" data-target="#DeleteModal" style="width:45%;" class="btn btn-sm btn-danger "> Hapus Hak Akses</a>
                                            <?php elseif($i->deleted_at != NULL): ?> 
                                                <a href="#" data-toggle="modal" onclick="backData(<?php echo e($i->id); ?>)" data-target="#BackModal" style="width:45%;" class="btn btn-sm btn-success "> Kembalikan Hak Akses</a>
                                            <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel_05\laravel Fix auth crud_2\resources\views/admin/pengguna/pengguna.blade.php ENDPATH**/ ?>
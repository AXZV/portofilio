...
<!-- /////////////////////////////// Toast CTRL /////////////////////////////// -->
    ...
    <?php if(session()->has('successloginadmin')): ?>
    <?php  echo 
            "<script> 
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_04\laravel Fix auth crud_2\resources\views//admin/admin_dasboard.blade.php ENDPATH**/ ?>
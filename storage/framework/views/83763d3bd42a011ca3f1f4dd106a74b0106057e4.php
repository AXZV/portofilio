...
<!-- /////////////////////////////// Error Code /////////////////////////////// -->
    <?php if($errors->any()): ?>
        <?php if($errors->has('no_identitas') || $errors->has('username') || $errors->has('password')): ?>
        <script>
            $(document).ready(function(){
                            ...
                            <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <?php echo e($i->tanggal_lulus); ?></td>
                                        <td> <?php echo e($i->status_bayar); ?></td>
                                        <td> <?php echo e($i->jumlah_bayar); ?></td>
                                        <td> <?php echo e($i->tanggal_bayar); ?></td>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input required value="<?php echo e(old('tanggal_lahir')); ?>" type="date" name="tanggal_lahir" class="form-control" id="tanggal_lahir" placeholder="Tanggal Lahir">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input required value="<?php echo e(old('tanggal_masuk')); ?>" type="date" name="tanggal_masuk" class="form-control" id="tanggal_masuk" placeholder="Tanggal Masuk">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <label for="tanggal_lulus">Tanggal Lulus</label>
                                    <input value="<?php echo e(old('tanggal_lulus')); ?>" type="date" name="tanggal_lulus" class="form-control" id="tanggal_lulus" placeholder="Tanggal Keluar">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo e(old('tanggal_bayar')); ?>" type="datetime-local" name="tanggal_bayar" class="form-control" id="tanggal_bayar" placeholder="Tanggal Bayar">
                                </div>
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel_05\laravel Fix auth crud_2\resources\views/admin/siswa.blade.php ENDPATH**/ ?>
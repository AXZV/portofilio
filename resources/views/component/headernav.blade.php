                        ...
                        <div class="custom-scroll h-100">
                            <ul class="notification">
                                ...
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                        <span class="status status-success mr-2">
                                            <!-- <img src="{{ asset('img/demo/avatars/avatar-m.png') }}" data-src="{{ asset('img/demo/avatars/avatar-h.png') }}" class="profile-image rounded-circle" alt="Sarah McBrook" /> -->
                    ...
                    <div class="tab-pane" id="tab-feeds" role="tabpanel">
                        <div class="custom-scroll h-100">
                            <ul class="notification">
                                ...
                                <li>
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        <!--<img src="{{ asset('img/demo/avatars/avatar-m.png') }}" data-src="{{ asset('img/demo/avatars/avatar-k.png') }}" class="profile-image rounded-circle" alt="k" />-->
                                        <div class="d-flex flex-column flex-1">
                                            <span class="name">
                                ...
                                <li>
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        <!--<img src="{{ asset('img/demo/avatars/avatar-m.png') }}" data-src="{{ asset('img/demo/avatars/avatar-e.png') }}" class="profile-image-sm rounded-circle align-self-start mt-1" alt="k" />-->
                                        <div class="d-flex flex-column flex-1">
                                ...
                                <li>
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        <!--<img src="{{ asset('img/demo/avatars/avatar-m.png') }}" data-src="{{ asset('img/demo/avatars/avatar-h.png') }}" class="profile-image rounded-circle align-self-start mt-1" alt="k" />-->
                                        <div class="d-flex flex-column flex-1">
                                            <div class="name mb-2">

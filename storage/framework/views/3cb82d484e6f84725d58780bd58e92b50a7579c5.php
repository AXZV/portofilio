                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input required  type="text" autocomplete="off" value="<?php echo e(old('tanggal_lahir')); ?>" name="tanggal_lahir" class="form-control" id="datepicker-3" placeholder="tanggal_lahir">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input required  type="text" autocomplete="off" value="<?php echo e(old('tanggal_keluar')); ?>" name="tanggal_keluar" class="form-control" id="tanggal_keluar" placeholder="Tanggal Keluar">
                                        <div class="input-group-append">
                                            <span class="input-group-text fs-xl">
                                                <i class="fal fa-calendar-alt"></i>
                                            </span>

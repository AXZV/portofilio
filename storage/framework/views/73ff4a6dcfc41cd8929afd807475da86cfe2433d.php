    ...
    <div class="ml-auto d-flex">
                        ...
                        <div class="custom-scroll h-100">
                            <ul class="notification">
                                ...
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                        <span class="status status-success mr-2">
                                            <!-- <img src="<?php echo e(asset('img/demo/avatars/avatar-m.png')); ?>" data-src="<?php echo e(asset('img/demo/avatars/avatar-h.png')); ?>" class="profile-image rounded-circle" alt="Sarah McBrook" /> -->
                    ...
                    <div class="tab-pane" id="tab-feeds" role="tabpanel">
                        <div class="custom-scroll h-100">
                            <ul class="notification">
                                ...
                                <li>
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        <!--<img src="<?php echo e(asset('img/demo/avatars/avatar-m.png')); ?>" data-src="<?php echo e(asset('img/demo/avatars/avatar-k.png')); ?>" class="profile-image rounded-circle" alt="k" />-->
                                        <div class="d-flex flex-column flex-1">
                                            <span class="name">
                                ...
                                <li>
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        <!--<img src="<?php echo e(asset('img/demo/avatars/avatar-m.png')); ?>" data-src="<?php echo e(asset('img/demo/avatars/avatar-e.png')); ?>" class="profile-image-sm rounded-circle align-self-start mt-1" alt="k" />-->
                                        <div class="d-flex flex-column flex-1">
                                ...
                                <li>
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        <!--<img src="<?php echo e(asset('img/demo/avatars/avatar-m.png')); ?>" data-src="<?php echo e(asset('img/demo/avatars/avatar-h.png')); ?>" class="profile-image rounded-circle align-self-start mt-1" alt="k" />-->
                                        <div class="d-flex flex-column flex-1">
                                            <div class="name mb-2">
        ...
        <div>
            <a href="#" data-toggle="dropdown" title="drlantern@gotbootstrap.com" class="header-icon d-flex align-items-center justify-content-center ml-2">
                <img src="<?php echo e(asset('img/demo/avatars/avatar-admin.png')); ?>" class="profile-image rounded-circle" alt="Dr. Codex Lantern">
            ...
            <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                    <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                        <span class="mr-2">
                            <img src="<?php echo e(asset('img/demo/avatars/avatar-admin.png')); ?>" class="rounded-circle profile-image" alt="Dr. Codex Lantern">
                        </span>
...
</header><?php /**PATH C:\xampp\htdocs\Laravel_05\laravel Fix auth crud_2\resources\views/dashboard/component/headernav.blade.php ENDPATH**/ ?>
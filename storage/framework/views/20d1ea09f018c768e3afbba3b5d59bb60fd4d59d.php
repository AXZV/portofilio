...
<style>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4 col-xl-4 mb-4">
                    <div class="card cardx bg-info">
                        ...
                        <div class="value"><?php echo count($siswa->where('status_aktif', 'Aktif')) ?></div>
                        <div class="stat"></div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4 col-xl-4 mb-4">
                    <div class="card cardx bg-dark">
                        ...
                        <div class="value"><?php echo count($guru->where('status_aktif', 'Aktif')) ?></div>
                        <div class="stat"></div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4 col-xl-4 mb-4">
                    <div class="card cardx bg-warning">
                        ...
                        <div class="value"><?php echo e($pengajaran->count()); ?></div>
                        <div class="stat"></div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row row-grid no-gutters">
                        ...
                        <div class="col-12">
                            <?php
                                ...
                                $jumlahijin = 0; 
                            ?>
                            <?php $__currentLoopData = $jumlah_presensi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div class="col-sm-4 col-md-4">
                                    <div class="text-center py-1">
                                        <h6 class="mb-0 fw-700">
                                            ...
                                            <div class="chart_masuk m-2 position-relative d-inline-flex align-items-center justify-content-center" data-percent="<?php echo e($persen_jumlahmasuk); ?>">
                                                <div class="d-flex flex-column align-items-center justify-content-center position-absolute pos-left pos-right pos-top pos-bottom fw-300 fs-lg">
                                                    <span class="text-success font-weight-bold"><?php echo e($persen_jumlahmasuk); ?> %</span>  
                                                </div>
                                            </div>
                                        </h6>
                                    </div>
                                ...
                                <div class="col-sm-4 col-md-4">
                                    <div class="text-center py-1">
                                        <h6 class="mb-0 fw-700">
                                            ...
                                            <div class="chart_tmasuk m-2 position-relative d-inline-flex align-items-center justify-content-center" data-percent="<?php echo e($persen_jumlahtidakmasuk); ?>">
                                                <div class="d-flex flex-column align-items-center justify-content-center position-absolute pos-left pos-right pos-top pos-bottom fw-300 fs-lg">
                                                    <span class="text-danger font-weight-bold"><?php echo e($persen_jumlahtidakmasuk); ?> %</span>  
                                                </div>
                                            </div>
                                        </h6>
                                    </div>
                                ...
                                <div class="col-sm-4 col-md-4">
                                    <div class="text-center py-1">
                                        <h6 class="mb-0 fw-700">
                                            ...
                                            <div class="chart_ijin m-2 position-relative d-inline-flex align-items-center justify-content-center" data-percent="<?php echo e($persen_jumlahijin); ?>">
                                                <div class="d-flex flex-column align-items-center justify-content-center position-absolute pos-left pos-right pos-top pos-bottom fw-300 fs-lg">
                                                    <span class="text-warning font-weight-bold"><?php echo e($persen_jumlahijin); ?> %</span>  
                                                </div>
                                            </div>
                                        </h6>
                                    </div>
                                ...
                                <?php $__currentLoopData = $pengajaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                       
                                    <div class="col-sm-6 col-md-6">
                                        ...
                                        <div class="card card-cascade hover-highlight m-1 text-center">
                                            <h5 class="text-dark pb-2 pt-1 text-capitalize font-weight-bold mt-2"><?php echo e($p->guru_kelas->kelas->nama); ?></h5>
                                            <div class="row no-gutters row-grid text-dark">
                                                <div class="col-md-6">
                                                    <div class="text-center py-3">
                                                        <h6 class="mb-0 fw-700 text-dark">
                                                            Guru
                                                            <small class="text-muted mb-0 text-capitalize small"><?php echo e($p->guru_kelas->guru->nama_depan); ?> <?php echo e($p->guru_kelas->guru->nama_belakang); ?></small>
                                                        </h6>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="text-center py-3">
                                                        <h6 class="mb-0 fw-700 text-dark">
                                                            Siswa
                                                            <small class="text-muted mb-0 small"><?php echo e($p->siswa->count()); ?> Orang</small>
                                                        </h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row no-gutters row-grid text-dark">
                                                <div class="col-md-12">
                                                    <small class="text-muted mb-0 text-capitalize small"> <span class="fas fa-map-signs text-info"></span> <?php echo e($p->guru_kelas->guru->instansi->nama); ?></small>
                                                </div>
                                            </div>
                                            <div class="row no-gutters row-grid text-dark">
                                                <div class="col-md-4">
                                            ...
                                            <div class="row no-gutters row-grid text-dark">
                                                <div class="col-md-4">
                                                    <small class="text-success mb-0"><?php echo e($persen_jumlahmasuk2); ?> %</small>
                                                </div>
                                                <div class="col-md-4">
                                                    <small class="text-danger mb-0"><?php echo e($persen_jumlahtidakmasuk2); ?> %</small>
                                                </div>
                                                <div class="col-md-4">
                                                    <small class="text-warning mb-0"><?php echo e($persen_jumlahijin2); ?> %</small>
                                                </div>
                                                <div class="col-md-12">
                                                    <small class="text-muted mb-0"><?php echo e($pertemuan); ?> x Pertemuan</small>
                                                </div>
                        ...
                        <div class="panel-content">
                                ...
                                <?php $__currentLoopData = $instansi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                       
                                    <div class="col-sm-6 col-md-6">
                                        ...
                                        <?php $__currentLoopData = $guru->where('kode_instansi', '=', $i->kode)->where('status_aktif', '=', 'Aktif'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php 
                                                $jumlahguru += 1; 
                                            ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php $__currentLoopData = $siswa->where('kode_instansi', '=', $i->kode)->where('status_aktif', '=', 'Aktif'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php 
                                                $jumlahsiswa += 1; 
                                            ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <!-- Card Narrower -->
                                        <div class="card card-cascade hover-highlight m-1 text-center">
                                            <h5 class="text-dark pb-2 pt-1 text-capitalize font-weight-bold mt-2"><?php echo e($i->nama); ?></h5>
                                            <div class="row no-gutters row-grid text-dark">
                                                <div class="col-md-6">
                                                    <div class="text-center py-3">
                                                        <h6 class="mb-0 fw-700 text-dark">
                                                            Guru
                                                            <small class="text-muted mb-0 text-capitalize small"><?php echo e($jumlahguru); ?> Guru</small>
                                                        </h6>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="text-center py-3">
                                                        <h6 class="mb-0 fw-700 text-dark">
                                                            Siswa
                                                            <small class="text-muted mb-0 small"><?php echo e($jumlahsiswa); ?> Siswa</small>
                                                        </h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 mb-2">
                                                    <h6 class="mb-0 fw-700 text-dark">
                                                        <small class="text-muted mb-0 text-capitalize small"> <span class="fas fa-map-signs text-info"></span> &nbsp; <?php echo e($i->status_pusat); ?></small>
                                                    </h6>
                                                </div>
                                            </div>                                  
                                        </div>
    ...
    <script src="<?php echo e(asset('js/jquery-3.2.1.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/statistics/easypiechart/easypiechart.bundle.js')); ?>"></script>

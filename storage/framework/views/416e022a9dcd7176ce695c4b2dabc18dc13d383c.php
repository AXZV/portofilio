...
<!-- /////////////////////////////// Toast CTRL /////////////////////////////// -->
    ...
    <?php if(session()->has('successedituser')): ?>
    <script>
            ...
            <div class="card mb-g rounded-top">
                <div>
                    <a class="float-right m-2 text-success" href="#" data-toggle="modal" 
                            onclick="editData( 
                                '<?php echo e($guru->id); ?>',
                                '<?php echo e($guru->no_identitas); ?>',
                                '<?php echo e($guru->nama_depan); ?>', 
                                '<?php echo e($guru->nama_belakang); ?>',
                                '<?php echo e($guru->tanggal_lahir); ?>',
                                '<?php echo e($guru->tempat_lahir); ?>',
                                '<?php echo e($guru->jenis_kelamin); ?>',
                                '<?php echo e($guru->agama); ?>',
                                '<?php echo e($guru->alamat); ?>',
                                '<?php echo e($guru->alamat_domisili); ?>',
                                '<?php echo e($guru->no_telp); ?>',
                                '<?php echo e($guru->email); ?>',)"
                            data-target="#editdata"><span class="fas fa-user-cog fa-lg"></span></a>
                    <a class="float-right m-2 text-danger" data-toggle="modal" onclick="edituser( '<?php echo e($pengguna->id); ?>', '<?php echo e($pengguna->username); ?>')" data-target="#edituser"><span class="fas fa-user-lock fa-lg"></span></a>
                </div> 
                    ...
                    <div class="col-12">
                        <div class="d-flex flex-column align-items-center justify-content-center p-4">
                            ...
                            <h5 class="mb-0 fw-700 text-center mt-3" style="text-transform: uppercase;">
                                ...
                                <small class="text-muted mb-0" style="text-transform: capitalize"><?php echo e($guru->tempat_lahir); ?>, <?php echo date('d F Y', strtotime($guru->tanggal_lahir)); ?></small>
                                <small class="text-muted mb-0" style="text-transform: capitalize"><span class="fa fa-phone"></span>&nbsp; <?php echo e($guru->no_telp); ?> &nbsp; &nbsp;<span class="far fa-envelope"></span>&nbsp; <?php echo e($guru->email); ?> </small>
                            </h5>
                        </div>
                    </div>
                    <div class="col-6">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master_3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel_05\laravel Fix auth crud_2\resources\views/guru/pengaturan/pengaturan.blade.php ENDPATH**/ ?>